...
train_loader, test_loader = loadData(SOURCE + THIRD_SOURCE + TRAIN_FOLDER +'/', SOURCE + THIRD_SOURCE + TEST_FOLDER +'/', BATCH_SIZE)
...
def firstTrain(epochs = EPOCHS):
    ...
    plt.savefig(IMAGE_DIR + str(best_correct) + '_' + str(test_volume) + '_' + str(round(best_accuracy)) + '_' + '.png')
